  ...
  head: () => ({
    meta: [
      ...
      { title: "AgroVision Analytics — Farm Health Intelligence" },
      {
        name: "description",
        content:
          "A precision-agriculture operating system for real-time soil, crop, and irrigation intelligence across every plot of your farm.",
      },
      { property: "og:title", content: "AgroVision Analytics — Farm Health Intelligence" },
      {
        property: "og:description",
        content:
          "Live soil moisture, NPK, and crop health across 12 plots. Timeline scrubbing, AI insights, and a farm-grade operating system.",
      },
